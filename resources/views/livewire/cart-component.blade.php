            ...
            <div class="summary">
                <div class="order-summary">
                    ...
                    @if(Session::has('coupon'))
                        <p class="summary-info"><span class="title">Discount ({{Session::get('coupon')['code']}}) <a href="#" wire:click.prevent="removeDiscount"><i class="fa fa-times text-danger"></i></a></span><b class="index">-${{$discount}}</b></p>
                        ...
                        <div class="summary-item">
                            <form wire:submit.prevent="applyCouponCode">
                                ...
                                <div class="row-in-form">
                                    ...
                                    <input type="text" class="form-control" name="coupon-code" wire:model="couponCode" />
                                </div>
