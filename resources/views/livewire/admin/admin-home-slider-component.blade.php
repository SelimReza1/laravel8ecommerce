                        ...
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="" onclick="confirm('Are you sure,You want to delete this product?')" wire:click.prevent="deleteSlider({{$slider->id}})"><i class="fa fa-trash fa-2x text-danger"></i></a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
