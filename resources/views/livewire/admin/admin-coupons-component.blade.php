                            ...
                            @foreach($coupons as $coupon)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#" onclick="confirm('Are you sure,You want to delete this product?')" wire:click.prevent="couponDelete({{$coupon->id}})" style="margin-left: 10px"><i class="fa fa-trash fa-2x text-danger"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
